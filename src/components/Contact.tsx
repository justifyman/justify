...
const Contact: FC = () => {
  return (
    <section className="min-h-screen bg-[#0a0a13] flex items-center justify-center text-center p-4">
      <div className="bg-[#1a1a2e] py-8 md:py-35 px-6 md:px-65 rounded-lg w-full md:w-auto">
